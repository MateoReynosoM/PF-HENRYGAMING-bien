    ...
    <div className="container-fluid text-center text-md-left">
        <div className="row">
            ...
            <div className="col-md-2 mb-md-0 mb-2">
                <h5 id="company"className="text-uppercase">Company</h5>
            ...
            <div className="col-md-2 mb-md-0 mb-2">
                <h5 id="company"className="text-uppercase">Information</h5>
            ...
            <div className="col-md-2 mb-md-0 mb-2">
                <h5 id="company" className="text-uppercase">Follow Us</h5>
